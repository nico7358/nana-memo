...
const CogIcon = React.memo<{className?: string}>(({className}) => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M11.078 2.25c-.917 0-1.699.663-1.943 1.54l-.062.311a11.96 11.96 0 0 0-3.056 2.3l-.18.18-1.48-1.03a1.99 1.99 0 0 0-2.484.253l-.999 1.001a1.99 1.99 0 0 0-.253 2.484l1.03 1.48-.18.18a11.96 11.96 0 0 0-2.3 3.056l-.31.062a1.99 1.99 0 0 0-1.542 1.943v1.498c0 .917.663 1.699 1.54 1.943l.311.062a11.96 11.96 0 0 0 2.3 3.056l.18.18-1.03 1.48a1.99 1.99 0 0 0 .253 2.484l1 1a1.99 1.99 0 0 0 2.484.253l1.48-1.03.18.18a11.96 11.96 0 0 0 3.056 2.3l.062.311a1.99 1.99 0 0 0 1.943 1.54h1.498c.917 0 1.699-.663 1.943-1.54l.062-.311a11.96 11.96 0 0 0 3.056-2.3l.18-.18 1.48 1.03a1.99 1.99 0 0 0 2.484-.253l.999-1.001a1.99 1.99 0 0 0 .253-2.484l-1.03-1.48.18-.18a11.96 11.96 0 0 0 2.3-3.056l.31-.062a1.99 1.99 0 0 0 1.542-1.943v-1.498c0-.917-.663-1.699-1.54-1.943l-.311-.062a11.96 11.96 0 0 0-2.3-3.056l-.18-.18 1.03-1.48a1.99 1.99 0 0 0-.253-2.484l-1-1a1.99 1.99 0 0 0-2.484-.253l-1.48 1.03-.18-.18a11.96 11.96 0 0 0-3.056-2.3l-.062-.311a1.99 1.99 0 0 0-1.943-1.54H11.078ZM12 15.75a3.75 3.75 0 1 0 0-7.5 3.75 3.75 0 0 0 0 7.5Z"
      clipRule="evenodd"
    />
  </svg>
));
